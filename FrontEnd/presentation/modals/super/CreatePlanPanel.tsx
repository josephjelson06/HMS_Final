...
const CreatePlanPanel: React.FC<CreatePlanPanelProps> = ({ isOpen, onClose }) => {
  ...
  const [selectedModules, setSelectedModules] = useState<string[]>(["Front Desk", "Guest Registry"]);

  // Visibility handled by hook below
      ...
      >
        <div className="h-full flex flex-col relative overflow-hidden">
            ...
            <div className={`px-8 py-6 border-b shrink-0 flex items-center justify-between ${isDarkMode ? 'border-white/10' : 'border-gray-200/50'}`}>
                <div>
                    <h2 className="text-2xl font-black dark:text-white tracking-tighter uppercase">Define New Offering</h2>
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-1">Catalog Entry Form</p>
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-12 custom-scrollbar">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="col-span-2">
                            ...
                            <input type="text" placeholder="e.g. Starter, Premium, Ultimate" className={inputClass} />
                        </div>
                        <div>
                            <label className={labelClass}>Monthly Price (INR) *</label>
                            <div className="relative">
                                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">₹</span>
                                <input type="number" className={`${inputClass} pl-8`} placeholder="0" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" className={inputClass} placeholder="e.g. 50" />
                        </div>
                        <div>
                ...
                {/* Included Modules Section - Screenshot 1 Style */}
                <section>
                    <div className={screenshotHeaderClass}>
                ...
                <section>
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            <label className={labelClass}>Internal Catalog Notes</label>
                            <textarea rows={4} placeholder="Pricing justification, sales strategy..." className={`${inputClass} font-medium leading-relaxed resize-none`} />
                        </div>
                    </div>
                </section>
