...
const UpdatePlanPanel: React.FC<UpdatePlanPanelProps> = ({
  isOpen,
  onClose,
  plan,
  onUpdate,
  ...
  useEffect(() => {
    if (isOpen && plan) {
      ...
      setMaxRooms(plan.max_rooms || 0);
      setMaxUsers(plan.max_users || 0);
      setMaxRoles(plan.max_roles || 0);
      // setSupportLevel(plan.support); // Not in entity
      // setSelectedModules(plan.included || []); // Not in entity
    }
  }, [isOpen, plan]);
