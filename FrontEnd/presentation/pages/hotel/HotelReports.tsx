...
const IntelligenceCard = ({ icon: Icon, title, description, formats, colorClass }: any) => {
  return (
    <GlassCard className="flex flex-col items-center text-center p-10 h-full border-white/10 hover:border-accent/30 transition-all group shadow-2xl">
      ...
      <button className="flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-900 dark:text-white group-hover:text-accent-strong transition-colors mt-auto">
