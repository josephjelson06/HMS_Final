...
const HotelReports: React.FC = () => {
  ...
  const reportConfigs: Record<string, { cols: string[] }> = {
    'gst': {
       cols: ['Guest Name', 'Nationality', 'Check-In Date', 'Check-Out Date', 'Room Number', 'Mobile', 'Email', 'ID Proof Type']
    },
    'usr': {
       cols: ['User Name', 'Role', 'Email', 'Phone', 'Status', 'Date Added', 'Employee ID']
    }
  };
