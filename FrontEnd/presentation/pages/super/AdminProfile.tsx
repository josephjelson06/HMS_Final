...
const AdminProfile: React.FC = () => {
    ...
    const avatarUrl = user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(formData.name || 'User')}&background=0D8ABC&color=fff&size=128`;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                    <GlassCard className="flex flex-col items-center text-center p-10">
                        ...
                        <p className="text-[10px] font-bold uppercase tracking-widest text-accent-strong">{user?.role} (Root Access)</p>
