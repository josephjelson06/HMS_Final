...
import { X, Check, ChevronDown, Layout, Monitor, Headphones, Save } from 'lucide-react';
      ...
      >
        <div className="h-full flex flex-col relative overflow-hidden">
            ...
            <div className={`px-8 py-6 border-t shrink-0 flex justify-end gap-3 ${isDarkMode ? 'border-white/10 bg-black/20' : 'border-gray-200/50 bg-white/50'}`}>
                ...
                <button 
                  onClick={handleSave}
                  className="px-10 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest bg-gray-900 dark:bg-white text-white dark:text-black shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center gap-2"
                >
