            ...
            {plans.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-lg font-black dark:text-white">Ôé╣{p.price.toLocaleString()}</p>
                </button>
              );
            })}
          </div>
            ...
            <div className="flex justify-between items-end">
              <div className="space-y-1">
                ...
                <p className={`text-xl font-black ${priceDiff > 0 ? 'text-accent' : 'text-emerald-500'}`}>
                  {priceDiff > 0 ? `+ Ôé╣${priceDiff.toLocaleString()}` : `- Ôé╣${Math.abs(priceDiff).toLocaleString()}`}
                </p>
              </div>
